        ...
        if(tagKey.equals(ECItemTags.ELYTRA_SLOT_ALLOW)
             ...
             || ElytraslotCompat.PLATFORM.isModLoaded("curios") && tagKey.equals(ECItemTags.CURIOS_SLOT_ALLOW)
                ...
                || (ElytraslotCompat.PLATFORM.isModLoaded("accessories") &&
                  (ElytraslotCompat.PLATFORM.isModLoaded("curios") && tagKey.equals(ECItemTags.ACCESSORIES_ALLOW_BACK)
                || ElytraslotCompat.PLATFORM.isModLoaded("trinkets") && tagKey.equals(ECItemTags.ACCESSORIES_ALLOW_CAPE))
